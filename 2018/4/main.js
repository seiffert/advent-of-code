import { guardsSleepS1, guardsSleepS2 } from "./guardsSleep";

const INPUT = `[1518-05-27 00:42] falls asleep
...
console.log("Result Strategy 1", guardsSleepS1(INPUT));
console.log("Result Strategy 2", guardsSleepS2(INPUT));
