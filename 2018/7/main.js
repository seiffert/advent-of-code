import { sortDependencies, processDependencies } from "./dependencies";
...
console.log("result:", sortDependencies(INPUT));
console.log("result with two workers:", processDependencies(INPUT, 15, 60));
